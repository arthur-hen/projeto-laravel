...
<head>
  ...
  /* Faixa invisível na borda direita da sidebar para arrastar */
  .resize-handle {
    position: absolute;
    top: 0;
    right: 0;
...
<style>
  ...
  [data-sidebartype="mini-sidebar"] .body-wrapper {
    margin-left: 180px !important;
  }
</style>

<style>
  /* move o conteúdo principal mais para a direita */
  .body-wrapper {
    margin-left: 300px !important; /* aumenta o espaço lateral */
  }

  /* centraliza o conteúdo dentro da área visível */
...
<style>
  /* desloca toda a área de conteúdo principal */
  .body-wrapper {
    margin-left: 320px !important; /* empurra tudo mais à direita */
    display: flex;
    justify-content: center;
  }

  /* centraliza dentro do espaço visível */
  main, .container, .content-wrapper, .card, form {
    width: 100%;
    max-width: 500px; /* limita a largura para não ficar muito largo */
  }
    ...
    <div class="app-topstrip bg-dark py-6 px-3 w-100 d-lg-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center justify-content-center gap-5 mb-2 mb-lg-0">
        <a class="d-flex justify-content-center" href="https://www.wrappixel.com/" target="_blank">
          <img src="admin/src/assets/images/logos/logo-wrappixel.svg" alt="" width="150">
        </a>
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="admin/src/assets/images/logos/logo.svg" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          ...
          <div
            ...
            <div class="unlimited-access-img">
              <img src="admin/src/assets/images/backgrounds/sidebar-buynow-bg.png" alt="" class="img-fluid">
            </div>
          </div>
        </nav>
    ...
    <div class="body-wrapper">
      ...
      <div class="body-wrapper-inner">
        <div class="container-fluid">
          ...
          <!-- inicio da inclusão do formulário -->
        <!-- 
          ...
          @endif
           ...
           <div class="alert alert-danger" role="alert">
            ...
            <div class="input-group">
              <input type="text" class="form-control" placeholder="Digite um CPF" aria-label="Username"
            ...
            <br>
            <label> Email </label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Digite um Email">
        ...
        -->
        <div class="col-12">
    <a href="{{ route('clientes.cadastrar') }}" class="btn btn-primary">Cadastro de clientes</a>
</div>
        ...
        <!-- fim da inclusão do formulario -->
<script>
document.addEventListener("DOMContentLoaded", () => {
  const sidebar = document.querySelector(".left-sidebar");
  const bodyWrapper = document.querySelector(".body-wrapper");

  // Cria a faixa de redimensionamento
